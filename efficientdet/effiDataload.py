...
def mk_train_csv():
	label_json = '../../../../DATA/data_teeth/train_label.json'
	img_base_path = '../dataset_nochange/images/train'
...
class LoadDataset(Dataset):
	def __init__(self, image_names, train_csv=None, which='train', root='../dataset_nochange/images/', p=0.3, imsize=1280):
		super().__init__()
